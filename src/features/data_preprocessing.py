...
if __name__ == "__main__":
    ...
    logger.info(f"Saving transformed train data to: {save_train_trans_path}")
    save_data(train_trans_df, save_train_trans_path)
    logger.info("Train data saved successfully")

    logger.info(f"Saving transformed test data to: {save_test_trans_path}")
    ...
    logger.info(f"Saving preprocessor to: {transformer_save_dir / transformer_filename}")
